...
import { Github, Linkedin, X, AppWindow, Server} from 'lucide-react';
...
const projectsData: Project[] = [
  {
    id: 1,
    title: "MetaMapa",
    description: "A robust backend system built with Java and Spring Boot, designed to manage and verify crowdsourced data events. The architecture is modular (Static, Dynamic, Aggregation) and implements advanced software design patterns. Key features include a configurable Consensus Engine (Strategy Pattern) to validate community inputs, an automated Spam Detection system using TF-IDF algorithms, and a Pub/Sub notification mechanism. The system also handles data normalization, CSV bulk importation, and provides a secure REST API protected by JWT authentication.",
    image: "./MetaMapa.png",
    githubUrlBack: "https://github.com/LautaroPingitore/Back-Disenio/tree/branch_local",
    githubUrlFront: "https://github.com/LautaroPingitore/Front-Disenio/tree/branch_local"
  },
  {
    id: 2,
    title: "BirBnb",
  ...
  {
    id: 4,
    title: "Master of Files - Distributed System",
    description: "This distributed system was developed in C as part of the Operating Systems course. The architecture is composed of four distinct modules (Query Control, Master, Worker, and Storage) that interact to process file operations concurrently. The system features a central scheduler implementing FIFO and Priority with Aging algorithms, and Workers that manage virtual memory using demand paging and LRU/Clock-M replacement strategies. Additionally, it includes a custom File System implementation that handles block allocation, bitmap management, and data deduplication using MD5 hashing.",
    image: "./MasterOfFiles.png",
    githubUrl: "https://github.com/LautaroPingitore/Tp-Operativos-2C2025"
  },
  {
    id: 5,
    title: "WollokGame",
      ...
      <footer className="bg-[#0a0017] py-6 sm:py-10 px-4 sm:px-[10%] text-white">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 mx-0 sm:mx-[5%]">
          ...
          <div className="flex gap-4 sm:gap-5">
            ...
            <a 
              href="https://www.linkedin.com/in/lautaro-pingitore/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:scale-110 transition-transform"
              aria-label="LinkedIn"
